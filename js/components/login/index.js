            ...
            <Container>
                <View theme={theme}>
                    <Image source={require('../../../images/bg.jpg')} style={styles.background}>
                        <ScrollView style={styles.main} keyboardShouldPersistTaps={true} contentOffset={this.state.offset} keyboardDismissMode='on-drag' ref={(scrollView) => { this._scrollView = scrollView }}>
