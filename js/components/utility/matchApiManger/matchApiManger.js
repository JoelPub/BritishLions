...
export function getGameMomentum(type,gameID,handleSuccess,handleError) {
    let optionsInfo = {
      url: 'http://bilwebapp.azurewebsites.net/getGameMomentum',
      data: {id:gameID},
      onAxiosStart: null,
      onAxiosEnd: null,
      method: 'post',
...
export function  getGameSetPlays(gameId , onSuccess,OnError) {
  let optionsInfo = {
    url: 'http://bilwebapp.azurewebsites.net/getGameSetPlays',
    data: {id:gameId},
    onAxiosStart: null,
    onAxiosEnd: null,
    method: 'post',
...
export function getGameOnFire  (gameId , onSuccess,OnError) {
  let optionsInfo = {
    url: 'http://bilwebapp.azurewebsites.net/getGameOnFire',
    data: {id:gameId},
    onAxiosStart: null,
    onAxiosEnd: null,
    method: 'post',
...
export function getTimeLineLiveSummary (options, type, summaryData, handleSuccess, handleError) {
  let optionsInfo = {
    url: 'http://bilwebapp.azurewebsites.net/getTimelineLiveSummary',
    data: options,
    onAxiosStart: null,
    onAxiosEnd: null,
    method: 'post',
