...
const EYC3_BASE_URL = 'https://bitbucket.org/!api/2.0/snippets/JoelPub'
...
const EYC3_AUTO_POPULATED_SQUAD_URL = '/oa6M5/130fc8ad35a442fd9bbd754b0ece889c35412dec/files/snippet.json'
const EYC3_AUTO_POPULATED_SQUAD_URL_NAME = 'EYC3AutoPopulatedSquad'
// const EYC3_GET_MY_SQUAD_RATING_URL = '/getMySquadRating'
const EYC3_GET_MY_SQUAD_RATING_URL = '/7aKRe/fdd917ada669bc1efa73dd420817826757026b3e/files/snippet.json'
const EYC3_GET_MY_SQUAD_RATING_URL_NAME = 'EYC3GetMySquadRating'
// const EYC3_GET_PLAYER_PROFILE_URL = '/getPlayersProfile'
const EYC3_GET_PLAYER_PROFILE_URL = '/AaobX/1d84eb86124a4ea2f03a53906f04857674e0626b/files/snippet.txt'
const EYC3_GET_PLAYER_PROFILE_URL_NAME = 'EYC3GetPlayersProfile'
// const EYC3_GET_PLAYER_URL = '/getPlayersList'
const EYC3_GET_PLAYER_URL = '/ba6XK/29e777d8a1275dc8d54a4a66e31953dcd3849767/files/snippet.json'
const EYC3_GET_PLAYER_URL_NAME = 'EYC3FullPlayers'
// const EYC3_GET_EXPERTS_URL = '/getExpertList'
const EYC3_GET_EXPERTS_URL = '/rajKz/04da65a5c213693fed2a4732ff6227eabc5c8b3a/files/snippet.json'
...
const GOODFORM_GET_FAVORITE_PLAYER_URL = '/qaj49/0aa688af9bffda9804747d0d603b5cf23b1a7def/files/snippet.json'
...
const GOODFORM_GET_USER_CUSROMIZED_SQUAD_URL = '/rMGRB/0413b1d841bcdc748917853a6de4bdf420c542cf/files/snippet.json'
...
const GOODFORM_SAVE_USER_CUSROMIZED_SQUAD_URL = '/6aKz9/fc3bd6b2afc0061d3bc72c627bd441b95aa66288/files/snippet.json'
...
const EYC3_GETCOMPETITIONCENTREINFO_URL = '/janr5/66918457f97290aa79a4c4255bc78ba8c3b48cc1/files/snippet.json'
...
const EYC3_GETHISTORICALGAMERESULT_URL = '/x59K6/fccfc1b2dada8f34a615a438a76a04a55d82264b/files/snippet.json'
...
const EYC3_GETUSERCUSTOMIZEDSQUAD_URL = '/GKoKB/d130787f06473997cd85f0d79ce32c6e38a5ec7b/files/snippet.json'
...
const EYC3_SAVEUSERCUSTOMIZEDSQUAD_URL = '/raRpo/f1fc5beea61e0a63f7a81f32608867afdaf5a63a/files/snippet.json'
...
const EYC3_POST_COMPETITIONLADDER = '/janGK/c90118cabd393827cd1f57e60c14c61190d7694d/files/snippet.json'

const EYC3_POST_GETGROUPINFO_NAME = 'GetGroupInfo'
// // const EYC3_POST_GETGROUPINFO = '/GetGroupInfo'
const EYC3_POST_GETGROUPINFO = '/yarzL/fb350f75e3558f9d785db61277eccdedfcb276a9/files/snippet.json'

const EYC3_POST_CREATEAGROUP_NAME = 'CreateAGroup'
// const EYC3_POST_CREATEAGROUP = '/CreateAGroup'
const EYC3_POST_CREATEAGROUP = '/qar8e/badf731a86bad1f04015532268f6f8ea8353006f/files/snippet.json'

const EYC3_POST_LEAVEAGROUP_NAME = 'LeaveAGroup'
// const EYC3_POST_LEAVEAGROUP = '/LeaveAGroup'
const EYC3_POST_LEAVEAGROUP = '/narEL/65c414db18619e877b8c2a83d0996e98c4066472/files/snippet.json'

const EYC3_POST_JOINAGROUP_NAME = 'JoinAGroup'
// const EYC3_POST_JOINAGROUP = '/JoinAGroup'
const EYC3_POST_JOINAGROUP = '/5arAp/c631edc0ec759ed4bd040a2528a5f3587725d281/files/snippet.json'
